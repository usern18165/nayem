...
import ColorIcon from '../../../../../assets/profile/about/Color.png'
            ...
            <WorkItem>
              ...
              <div className="m">
                <h3 onClick={() => window.open(`${color?.name}`, "blank")}>
                 <div style={{width:"20px",height:"20px", borderRadius:"50%", backgroundColor:`rgb(${color.colorr}, ${color.colorg}, ${color.colorb})`}}> </div>
                </h3>
