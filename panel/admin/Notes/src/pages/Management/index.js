...
function Management() {
  ...
  const getAllModarator = () => {
    ...
    axios.get(`${BACKEND_URL}/admin/get-modarators`,
      { headers: adminHeader() }
    ).then(({ data }) => {
  ...
  const getSingleModaratorById = (id) => {
    ...
    axios.get(`${BACKEND_URL}/admin/get-modarator/${id}`,
      { headers: adminHeader() }
    ).then(({ data }) => {
  ...
  const SaveHandler = () => {
    ...
    axios.post(`${BACKEND_URL}/admin/admin-register`, modaratorAdd,
  ...
  const updateHandler = (id) => {
    ...
    axios.put(`${BACKEND_URL}/admin/update-admin-user/${id}`, modarator,
      { headers: adminHeader() }).then(({ data }) => {
        handleUpdateClose()
        getAllModarator()
        setModarator({});
  ...
  const deleteHandler = (id) => {
    ...
    axios.delete(`${BACKEND_URL}/admin/delete-admin-user/${id}`, {
      headers: adminHeader()
    }).then((res) => {

      const allModaratorsAfterDelete = modarators.filter(item => item?._id != id);
  ...
  const PasswordChangeHandler = (id) => {
    ...
    axios.put(`${BACKEND_URL}/admin/change-password/${id}`, changePass, {
      headers: adminHeader()
    }).then((res) => {
